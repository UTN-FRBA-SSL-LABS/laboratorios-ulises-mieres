...
> R:carrito_init inicializa en 0 la cantidad de productos del carrito. Es importante llamarla antes de usarlo para evitar que cantidad tenga un valor indeterminado y provoque resultados o accesos incorrectos.
...
> R: El test falla. Esperaba obtener 700, pero obtuvo 350.

```
TEST_TOTAL_CANTIDAD_PASA=SI 
```
_(SI o NO)_
...
> R:El test pasa. El quinto carrito_agregar devuelve 0.
...
> R:El operador incorrecto era <= y debía ser <, para impedir que se agregue un producto cuando cantidad ya es igual a MAX_ITEMS.
...
> R: Sí. Las líneas 29 y 30, correspondientes a la función carrito_descuento, aparecen con ##### porque los tests ejecutados para generar la cobertura no llaman a esa función.
